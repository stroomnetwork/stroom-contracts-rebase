...
contract strBTC2 is ERC20Upgradeable, ValidatorMessageReceiver
...
//        _grantRole(PAUSER_ROLE, _pauser);
     ...
     */
    function setMinWithdrawAmount(uint256 _minWithdrawAmount) public {
     ...
     */
    function setMaxRewardPercent(uint256 _maxRewardPercent) external {
     ...
     * @dev Only the contract owner can call this function
     */
    function setMinTimeBetweenRewards(uint256 _minTimeBetweenRewards) external {
     ...
     */
    function converterMint(address recipient, uint256 amount) external {
...
//        revert InvalidTotalSupplyNonce();
     ...
     */
    function redeem(uint256 _amount, string calldata BTCAddress) public {
